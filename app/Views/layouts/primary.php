...
<div class="d-flex flex-column justify-content-between" id="root">
        ...
        <div class="container ">
            <div class="row justify-content-between align-items-center py-3">
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    <li class="ms-3"><a class="text-muted" href="https://www.linkedin.com/in/rrahul32/">
                                ...
                                <li class="ms-3"><a class="text-muted" href="https://github.com/rrahul32">
