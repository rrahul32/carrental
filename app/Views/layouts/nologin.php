...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark mb-3">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link <?= $page == "home" ? "active" : "" ?>" aria-current="page" href="/">Available Cars</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item " href="/customer/signup">Customer</a></li>
                        <li><a class="dropdown-item " href="/agency/signup">Agency</a></li>
                    </ul>
                </li>
